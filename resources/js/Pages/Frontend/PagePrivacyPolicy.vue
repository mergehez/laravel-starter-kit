...
import AppLayout from "@/Components/Layout/LayoutFrontend.vue";
...
const author = 'Mazlum Ozdogan';
const authorEmail = 'argesozdogan@gmail.com';
</script>
...
<template>
    ...
    >
        ...
        <p>
            This privacy policy applies to the {{ page.props.info.siteTitle }} app (hereby referred to as "Application") for mobile devices
            that was created by {{ author }} (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
        </p>
        ...
        <p>
            ...
            identifiable information. The information that the Service Provider request will be retained by them and used as described in this privacy policy.
        </p>
        ...
        <p>
            ...
            and their service. The Service Provider may share your information with third parties in the ways that are described in this privacy statement.
        </p>
        ...
        <div>
            ...
            <ul>
                <li><a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer" class="btn-link-light">Google Play Services</a></li>
            </ul>
        </div>
        ...
        <ul>
            ...
            <li>
                when they believe in good faith that disclosure is necessary to protect their rights, protect your safety or the safety of others, investigate fraud,
                or respond to a government request;
            </li>
            <li>
                with their trusted services providers who work on their behalf, do not have an independent use of the information we disclose to them, and have agreed
        ...
        <p>
            ...
            If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at {{ authorEmail }}
        ...
        <div>
            ...
            <p>
                ...
                personal information, please contact the Service Provider ({{authorEmail}}) so that
        ...
        <p>
            ...
            Policy by updating this page with the new Privacy Policy. You are advised to consult this Privacy Policy regularly for any changes,
        ...
        <p>
            If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at {{authorEmail}}.
        </p>
    </LayoutFrontendContent>
</template>